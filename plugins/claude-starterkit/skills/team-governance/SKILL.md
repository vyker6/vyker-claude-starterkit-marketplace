...
1. Invoke the `claude-starterkit:claude-md-improver` skill
...
1. Invoke the `claude-starterkit:using-git-worktrees` skill for guidance
...
1. Invoke the `claude-starterkit:test-driven-development` skill for guidance
...
3. If frontend files changed:
   - Invoke the `claude-starterkit:frontend-design` skill
...
1. Invoke the `claude-starterkit:vibe-security` skill
...
1. Invoke the `claude-starterkit:verification-before-completion` skill:
...
2. Invoke the `claude-starterkit:requesting-code-review` skill:
...
4. If all tests pass:
   - Invoke the `claude-starterkit:finishing-a-development-branch` skill
